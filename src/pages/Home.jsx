...
// import HeroFinal from "../assets/images/HeroFinal.png";
...
//         // style={{ backgroundImage: `url(${universeHeroBg})` }}
//       >

//           <div className="pl-5 pt-10 md:pt-0">
//             <h1 className="text-7xl sm:text-7xl md:text-9xl font-extrabold bg-gradient-to-r from-yellow-300 via-amber-400 to-yellow-500 text-transparent bg-clip-text drop-shadow-xl animate-pulse transition duration-300">
//               UNIVERSE
//             </h1>
//             <h3 className="text-2xl sm:text-3xl md:text-[45px] font-semibold mt-2 pl-1 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-300 text-transparent bg-clip-text drop-shadow-lg transition-all duration-300 ease-in-out">
//               Explore the Infinite Possibilities
//             </h3>
//             <div><img src={universeHeroBg} className="w-[500px]" alt="" /></div>
//           </div>
//           <div className="">
//           <div className="flex flex-col justify-center items-center text-center px-6">

//             <div className="flex flex-wrap gap-5 md:gap-[400px] justify-between mt-[500px] md:mt-96 flex-col md:flex-row items-center z-[1]">
//               <div className="flex justify-center items-center h-14 w-64 bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 rounded-lg shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
//                 <Link
//                   to="/user-login"
//                   className="px-6 py-3 text-white text-lg font-semibold "
//                 >
//                   Ramestta
//                 </Link>
//               </div>
...
//                 </Link>
//               </div> */}
//               <div className="flex justify-center items-center h-14 w-64 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 rounded-lg shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
//                 <Link
//                   to="/express-login"
//                   className="px-6 py-3 text-white text-lg font-semibold bg-gradient-to-r "
//                 >
//                   Express
//                 </Link>
//               </div>
...
//               <div className=" relative top-0 md:top-10  text-xl sm:text-2xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-pink-500 to-blue-500 text-transparent bg-clip-text drop-shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
