...
//   const totalCirclesPerLevel = 10;

//   const levelProgress = [10, 2, 3, 1, 4];
...
//                   Universe
//                 </span>
//                 <span className="text-2xl md:text-xl font-bold"> U4</span>
//               </div>
//               <div className="flex flex-col md:flex-row justify-center md:justify-start items-center mt-10 gap-4 md:gap-20 ml-0 md:ml-22">
//                 <div className="text-white w-full md:w-36 text-center border-2  text-xl font-semibold py-2 ml-0 md:ml-[-50px]">
//                   Id
//                 </div>
